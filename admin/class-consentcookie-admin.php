...
class ConsentCookie_Admin {
    ...
    private function getCCCUrlPrefix() {
        ...
        if ($useCdn) {
            ...
            $urlPrefix = $this->options[OPT_CCC_CUSTOM_PATH];
        } else {
            $urlPrefix = plugins_url( CCC_PATH, __FILE__);
        }
        return $urlPrefix;
    }
    ...
    public static function get_options_list() {
        ...
        $options[] = array( OPT_CC_CUSTOM_PATH, 'text', '');
        $options[] = array( OPT_CCC_CUSTOM_PATH, 'text', '');
